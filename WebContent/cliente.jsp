...
<html lang="pt">
    <head>
        <meta charset="utf-8" />
        <title>Minura Enterprise - Cliente</title>
                            ...
                            <div class="col-sm-12">
                                <div class="page-title">
                                    <div class="row">
                                        ...
                                        <h4 class="pull-left">Registo Cliente</h4>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-card margin-b-30">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" action="HCliente" method="post">
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab1">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Nome</label>
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="nomecli" type="text" required="">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="sobcli" type="text" required="">
                                                        </div>
                                                        <div class="col-md-offset-3"></div>
                                                    </div>
                                                    <!-- End .control-group  -->
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="naciocli" class="form-control select2" required="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="moradacli" type="text" required="">
                                                        </div>
                                                        <div class="col-md-offset-3"></div>
                                                    </div>
                                                    <!-- End .control-group  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="localidadecli" type="text" required="">
                                                        </div>
                                                        <div class="col-md-offset-3"></div>
                                                    </div>
                                                    <!-- End .control-group  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="cpcli" type="text" required="">
                                                        </div>
                                                        <div class="col-md-offset-3"></div>
                                                    </div>
                                                    <!-- End .control-group  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="contactocli" type="text" required="">
                                                        </div>
                                                        <div class="col-md-offset-3"></div>
                                                    </div>
                                                    <!-- End .control-group  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="emailcli" type="email" required="">
                                                        </div>
                                                        <div class="col-md-offset-3"></div>
